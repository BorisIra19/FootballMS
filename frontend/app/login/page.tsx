    ...
    <div className="min-h-screen bg-gray-950 flex">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-green-950 via-gray-900 to-gray-950 items-center justify-center p-12">
        ...
        <div className="relative text-center">
          ...
          <h2 className="text-4xl font-extrabold text-white mb-4">Football<span className="text-green-400">MS</span></h2>
          <p className="text-gray-400 text-lg max-w-sm leading-relaxed">The complete platform to manage your football leagues, teams, and players.</p>
          <div className="mt-10 grid grid-cols-2 gap-4 text-left">
            {[['🏆', 'League Management'], ['👥', 'Team Tracking'], ['⚽', 'Match Results'], ['📊', 'Live Standings']].map(([icon, label]) => (
              <div key={label} className="flex items-center gap-3 bg-gray-800/50 rounded-xl px-4 py-3 border border-green-900/30">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/register" className="text-green-400 hover:text-green-300 font-medium transition-colors">Create one here</Link>
          </p>
